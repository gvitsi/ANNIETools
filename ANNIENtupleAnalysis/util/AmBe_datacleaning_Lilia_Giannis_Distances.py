...
def PlotDemo(Sdf,Sdf_trig):
    ...
    ranges = {'xbins': 200, 'ybins':200, 'xrange':[0,60000],'yrange':[0,2]}
    ...
    ranges = {'xbins': 200, 'ybins':200, 'xrange':[2000,60000],'yrange':[0,2]}
    ...
    ranges = {'xbins': 200, 'ybins':200, 'xrange':[0,2000],'yrange':[0,2]}
    plt.subplots_adjust(left=0.19, right=0.94, bottom=0.14, top=0.80, hspace=0.05, wspace=0.2) 
...
#--- CB>=0.9 
    ...
    #Sdf_prompt_pe20 = Sdf_prompt.loc[Sdf_prompt['clusterPE']<20].reset_index(drop=True) 
    #Sdf_del_pe20 = Sdf_del.loc[Sdf_del['clusterPE']<20].reset_index(drop=True)
    
    #clusterPE<20
    Sdf_prompt_highCB_pe20 = Sdf_prompt_highCB.loc[Sdf_prompt_highCB['clusterPE']<20].reset_index(drop=True) 
    Sdf_del_highCB_pe20 = Sdf_del_highCB.loc[Sdf_del_highCB['clusterPE']<20].reset_index(drop=True)
    
    Sdf_prompt_upperCB_pe20 = Sdf_prompt_upperCB.loc[Sdf_prompt_upperCB['clusterPE']<20].reset_index(drop=True) 
    Sdf_del_upperCB_pe20 = Sdf_del_upperCB.loc[Sdf_del_upperCB['clusterPE']<20].reset_index(drop=True)
    
    Sdf_prompt_midCB_pe20 = Sdf_prompt_midCB.loc[Sdf_prompt_midCB['clusterPE']<20].reset_index(drop=True) 
    Sdf_del_midCB_pe20 = Sdf_del_midCB.loc[Sdf_del_midCB['clusterPE']<20].reset_index(drop=True)
    
    Sdf_prompt_lowCB_pe20 = Sdf_prompt_lowCB.loc[Sdf_prompt_lowCB['clusterPE']<20].reset_index(drop=True) 
    Sdf_del_lowCB_pe20 = Sdf_del_lowCB.loc[Sdf_del_lowCB['clusterPE']<20].reset_index(drop=True)
    
    
    
    
    #clusterPE>20
    Sdf_prompt_highCB_pe20Up = Sdf_prompt_highCB.loc[Sdf_prompt_highCB['clusterPE']>20].reset_index(drop=True) 
    Sdf_del_highCB_pe20Up = Sdf_del_highCB.loc[Sdf_del_highCB['clusterPE']>20].reset_index(drop=True)
    
    Sdf_prompt_upperCB_pe20Up = Sdf_prompt_upperCB.loc[Sdf_prompt_upperCB['clusterPE']>20].reset_index(drop=True) 
    Sdf_del_upperCB_pe20Up = Sdf_del_upperCB.loc[Sdf_del_upperCB['clusterPE']>20].reset_index(drop=True)
    
    Sdf_prompt_midCB_pe20Up = Sdf_prompt_midCB.loc[Sdf_prompt_midCB['clusterPE']>20].reset_index(drop=True) 
    Sdf_del_midCB_pe20Up = Sdf_del_midCB.loc[Sdf_del_midCB['clusterPE']>20].reset_index(drop=True)
    
    Sdf_prompt_lowCB_pe20Up = Sdf_prompt_lowCB.loc[Sdf_prompt_lowCB['clusterPE']>20].reset_index(drop=True) 
    Sdf_del_lowCB_pe20Up = Sdf_del_lowCB.loc[Sdf_del_lowCB['clusterPE']>20].reset_index(drop=True)
    
    #plots for customized clusterPE
    #highCB plots 
    
    highCB_PE_prompt_pe20 = np.hstack(Sdf_prompt_highCB_pe20.hitPE)
    highCB_DetID_prompt_pe20 = np.hstack(Sdf_prompt_highCB_pe20.hitDetID)
    highCB_PE_del_pe20 = np.hstack(Sdf_del_highCB_pe20.hitPE)
    highCB_DetID_del_pe20 = np.hstack(Sdf_del_highCB_pe20.hitDetID)
    
    plt.hist2d(highCB_DetID_prompt_pe20,highCB_PE_prompt_pe20, bins=(200,136), range=[[330,465],[0,50]],cmap=plt.cm.turbo)
    plt.title("ClusterPE<20 \nPrompt PE distribution for all hits in clusters,\n CB>=0.9 " f"for position Z={z}cm")
    plt.colorbar()
    plt.xlabel("Tube ID")
    plt.ylabel("PE")
    plt.subplots_adjust(left=0.14, right=0.94, bottom=0.14, top=0.80, hspace=0.05, wspace=0.2) 
    plt.savefig(f"plots_AmBe/{z}/TubeID_PE_prompt_highCB_PE<20.png")
    plt.show()
    
    plt.hist2d(highCB_DetID_del_pe20,highCB_PE_del_pe20, bins=(200,136), range=[[330,465],[0,20]],cmap=plt.cm.turbo)
    plt.title("ClusterPE<20 \nDelayed PE distribution for all hits in clusters,\n CB>=0.9 " f"for position Z={z}cm")
    plt.colorbar()
    plt.xlabel("Tube ID")
    plt.ylabel("PE")
    plt.subplots_adjust(left=0.14, right=0.94, bottom=0.14, top=0.80, hspace=0.05, wspace=0.2) 
    plt.savefig(f"plots_AmBe/{z}/TubeID_PE_del_highCB_PE<20.png")
    plt.show()
    
     
    
    highCB_PE_prompt_pe20Up = np.hstack(Sdf_prompt_highCB_pe20Up.hitPE)
    highCB_DetID_prompt_pe20Up = np.hstack(Sdf_prompt_highCB_pe20Up.hitDetID)
    highCB_PE_del_pe20Up = np.hstack(Sdf_del_highCB_pe20Up.hitPE)
    highCB_DetID_del_pe20Up = np.hstack(Sdf_del_highCB_pe20Up.hitDetID)
    
    plt.hist2d(highCB_DetID_prompt_pe20Up,highCB_PE_prompt_pe20Up, bins=(200,136), range=[[330,465],[0,50]],cmap=plt.cm.turbo)
    plt.title("ClusterPE>20 \nPrompt PE distribution for all hits in clusters,\n CB>=0.9 " f"for position Z={z}cm")
    plt.colorbar()
    plt.xlabel("Tube ID")
    plt.ylabel("PE")
    ...
    plt.hist2d(highCB_DetID_del_pe20Up,highCB_PE_del_pe20Up, bins=(200,136), range=[[330,465],[0,20]],cmap=plt.cm.turbo)
    plt.title("ClusterPE>20 \nDelayed PE distribution for all hits in clusters,\n CB>=0.9 " f"for position Z={z}cm")
    plt.colorbar()
    plt.xlabel("Tube ID")
    plt.ylabel("PE")
    ...
    #upperCB plots
    upperCB_PE_prompt_pe20 = np.hstack(Sdf_prompt_upperCB_pe20.hitPE)
    upperCB_DetID_prompt_pe20 = np.hstack(Sdf_prompt_upperCB_pe20.hitDetID)
    upperCB_PE_del_pe20 = np.hstack(Sdf_del_upperCB_pe20.hitPE)
    upperCB_DetID_del_pe20 = np.hstack(Sdf_del_upperCB_pe20.hitDetID)
    
    plt.hist2d(upperCB_DetID_prompt_pe20,upperCB_PE_prompt_pe20, bins=(200,136), range=[[330,465],[0,50]],cmap=plt.cm.turbo)
    plt.title("ClusterPE<20 \nPrompt PE distribution for all hits in clusters,\n 0.6<=CB<0.9 " f"for position Z={z}cm")
    plt.colorbar()
    plt.xlabel("Tube ID")
    plt.ylabel("PE")
    plt.subplots_adjust(left=0.14, right=0.94, bottom=0.14, top=0.80, hspace=0.05, wspace=0.2) 
    plt.savefig(f"plots_AmBe/{z}/TubeID_PE_prompt_upperCB_PE<20.png")
    plt.show()
    
    plt.hist2d(upperCB_DetID_del_pe20,upperCB_PE_del_pe20, bins=(200,136), range=[[330,465],[0,20]],cmap=plt.cm.turbo)
    plt.title("ClusterPE<20 \nDelayed PE distribution for all hits in clusters,\n 0.6<=CB<0.9 " f"for position Z={z}cm")
    plt.colorbar()
    plt.xlabel("Tube ID")
    plt.ylabel("PE")
    plt.subplots_adjust(left=0.14, right=0.94, bottom=0.14, top=0.80, hspace=0.05, wspace=0.2) 
    plt.savefig(f"plots_AmBe/{z}/TubeID_PE_del_upperCB_PE<20.png")
    plt.show()
    
    
    
    
    upperCB_PE_prompt_pe20Up = np.hstack(Sdf_prompt_upperCB_pe20Up.hitPE)
    upperCB_DetID_prompt_pe20Up = np.hstack(Sdf_prompt_upperCB_pe20Up.hitDetID)
    upperCB_PE_del_pe20Up = np.hstack(Sdf_del_upperCB_pe20Up.hitPE)
    upperCB_DetID_del_pe20Up = np.hstack(Sdf_del_upperCB_pe20Up.hitDetID)
    
    plt.hist2d(upperCB_DetID_prompt_pe20Up,upperCB_PE_prompt_pe20Up, bins=(200,136), range=[[330,465],[0,50]],cmap=plt.cm.turbo)
    plt.title("ClusterPE>20 \nPrompt PE distribution for all hits in clusters,\n 0.6<=CB<0.9 " f"for position Z={z}cm")
    plt.colorbar()
    plt.xlabel("Tube ID")
    plt.ylabel("PE")
    ...
    plt.hist2d(upperCB_DetID_del_pe20Up,upperCB_PE_del_pe20Up, bins=(200,136), range=[[330,465],[0,20]],cmap=plt.cm.turbo)
    plt.title("ClusterPE>20 \nDelayed PE distribution for all hits in clusters,\n 0.6<=CB<0.9 " f"for position Z={z}cm")
    plt.colorbar()
    plt.xlabel("Tube ID")
    plt.ylabel("PE")
    ...
    #midCB plots
    midCB_PE_prompt_pe20 = np.hstack(Sdf_prompt_midCB_pe20.hitPE)
    midCB_DetID_prompt_pe20 = np.hstack(Sdf_prompt_midCB_pe20.hitDetID)
    midCB_PE_del_pe20 = np.hstack(Sdf_del_midCB_pe20.hitPE)
    midCB_DetID_del_pe20 = np.hstack(Sdf_del_midCB_pe20.hitDetID)
    
    plt.hist2d(midCB_DetID_prompt_pe20,midCB_PE_prompt_pe20, bins=(200,136), range=[[330,465],[0,50]],cmap=plt.cm.turbo)
    plt.title("ClusterPE<20 \nPrompt PE distribution for all hits in clusters,\n 0.4=<CB<0.6 " f"for position Z={z}cm")
    plt.colorbar()
    plt.xlabel("Tube ID")
    plt.ylabel("PE")
    plt.subplots_adjust(left=0.14, right=0.94, bottom=0.14, top=0.80, hspace=0.05, wspace=0.2) 
    plt.savefig(f"plots_AmBe/{z}/TubeID_PE_prompt_midCB_PE<20.png")
    plt.show()
    
    plt.hist2d(midCB_DetID_del_pe20,midCB_PE_del_pe20, bins=(200,136), range=[[330,465],[0,20]],cmap=plt.cm.turbo)
    plt.title("ClusterPE<20 \nDelayed PE distribution for all hits in clusters,\n 0.4=<CB<0.6 " f"for position Z={z}cm")
    plt.colorbar()
    plt.xlabel("Tube ID")
    plt.ylabel("PE")
    plt.subplots_adjust(left=0.14, right=0.94, bottom=0.14, top=0.80, hspace=0.05, wspace=0.2) 
    plt.savefig(f"plots_AmBe/{z}/TubeID_PE_del_midCB_PE<20.png")
    plt.show()
    
    
    
    
    midCB_PE_prompt_pe20Up = np.hstack(Sdf_prompt_midCB_pe20Up.hitPE)
    midCB_DetID_prompt_pe20Up = np.hstack(Sdf_prompt_midCB_pe20Up.hitDetID)
    midCB_PE_del_pe20Up = np.hstack(Sdf_del_midCB_pe20Up.hitPE)
    midCB_DetID_del_pe20Up = np.hstack(Sdf_del_midCB_pe20Up.hitDetID)
    
    plt.hist2d(midCB_DetID_prompt_pe20Up,midCB_PE_prompt_pe20Up, bins=(200,136), range=[[330,465],[0,50]],cmap=plt.cm.turbo)
    plt.title("ClusterPE>20 \nPrompt PE distribution for all hits in clusters,\n 0.4=<CB<0.6 " f"for position Z={z}cm")
    plt.colorbar()
    plt.xlabel("Tube ID")
    plt.ylabel("PE")
    ...
    plt.hist2d(midCB_DetID_del_pe20Up,midCB_PE_del_pe20Up, bins=(200,136), range=[[330,465],[0,20]],cmap=plt.cm.turbo)
    plt.title("ClusterPE>20 \nDelayed PE distribution for all hits in clusters,\n 0.4=<CB<0.6 " f"for position Z={z}cm")
    plt.colorbar()
    plt.xlabel("Tube ID")
    plt.ylabel("PE")
    ...
    #lowCB plots
    lowCB_PE_prompt_pe20 = np.hstack(Sdf_prompt_lowCB_pe20.hitPE)
    lowCB_DetID_prompt_pe20 = np.hstack(Sdf_prompt_lowCB_pe20.hitDetID)
    lowCB_PE_del_pe20 = np.hstack(Sdf_del_lowCB_pe20.hitPE)
    lowCB_DetID_del_pe20 = np.hstack(Sdf_del_lowCB_pe20.hitDetID)
    
    plt.hist2d(lowCB_DetID_prompt_pe20,lowCB_PE_prompt_pe20, bins=(200,136), range=[[330,465],[0,50]],cmap=plt.cm.turbo)
    plt.title("ClusterPE<20 \nPrompt PE distribution for all hits in clusters,\n CB<=0.4 " f"for position Z={z}cm")
    plt.colorbar()
    plt.xlabel("Tube ID")
    plt.ylabel("PE")
    plt.subplots_adjust(left=0.14, right=0.94, bottom=0.14, top=0.80, hspace=0.05, wspace=0.2) 
    plt.savefig(f"plots_AmBe/{z}/TubeID_PE_prompt_lowCB_PE<20.png")
    plt.show()
    
    plt.hist2d(lowCB_DetID_del_pe20,lowCB_PE_del_pe20, bins=(200,136), range=[[330,465],[0,20]],cmap=plt.cm.turbo)
    plt.title("ClusterPE<20 \nDelayed PE distribution for all hits in clusters,\n CB<=0.4 " f"for position Z={z}cm")
    plt.colorbar()
    plt.xlabel("Tube ID")
    plt.ylabel("PE")
    plt.subplots_adjust(left=0.14, right=0.94, bottom=0.14, top=0.80, hspace=0.05, wspace=0.2) 
    plt.savefig(f"plots_AmBe/{z}/TubeID_PE_del_lowCB_PE<20.png")
    plt.show()
    
    
    lowCB_PE_prompt_pe20Up = np.hstack(Sdf_prompt_lowCB_pe20Up.hitPE)
    lowCB_DetID_prompt_pe20Up = np.hstack(Sdf_prompt_lowCB_pe20Up.hitDetID)
    lowCB_PE_del_pe20Up = np.hstack(Sdf_del_lowCB_pe20Up.hitPE)
    lowCB_DetID_del_pe20Up = np.hstack(Sdf_del_lowCB_pe20Up.hitDetID)
    
    plt.hist2d(lowCB_DetID_prompt_pe20Up,lowCB_PE_prompt_pe20Up, bins=(200,136), range=[[330,465],[0,50]],cmap=plt.cm.turbo)
    plt.title("ClusterPE>20 \nPrompt PE distribution for all hits in clusters,\n CB<=0.4 " f"for position Z={z}cm")
    plt.colorbar()
    plt.xlabel("Tube ID")
    plt.ylabel("PE")
    ...
    plt.hist2d(lowCB_DetID_del_pe20Up,lowCB_PE_del_pe20Up, bins=(200,136), range=[[330,465],[0,20]],cmap=plt.cm.turbo)
    plt.title("ClusterPE>20 \nDelayed PE distribution for all hits in clusters,\n CB<=0.4 " f"for position Z={z}cm")
    plt.colorbar()
    plt.xlabel("Tube ID")
    plt.ylabel("PE")
